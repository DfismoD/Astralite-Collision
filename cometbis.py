...
class Cometbis(pygame.sprite.Sprite):

    def __init__(self, comet_event):
        super().__init__()
        self.health = 120
        self.max_health = 120 
        self.image = pygame.image.load("Assets/Meteorite_2.png")
    ...
    def damage(self, amount):
        ...
        if self.health <= 0:
            self.remove()
            self.comet_event.game.add_meteor2_score()
            self.comet_event.game.add_meteor2_xp()
